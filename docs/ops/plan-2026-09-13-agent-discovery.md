...
| 5 | **deployed 2026-09-14** (rehearsal 43/0/0 on the box; C-1 confirmed; merged f1ef74c; §5.1–5.4 and §5.6 verified; one real client). Outstanding: C-6 jail install, C-4 registry listing, re-scans, second client | see git log: "ops: the rehearsal's MCP rows…", "ops: record C-1…" | `research/agent-logs/agent-discovery-orchestrator-20260913.md` | 2026-09-14 (three entries) |
| 6 | not started | — | — | — |
| 7 | scoped only | — | — | — |
