...
| 5 | **done 2026-09-14** (deployed (rehearsal 43/0/0 on the box; C-1 confirmed; merged f1ef74c; §5.1–5.4 and §5.6 verified; one real client). isitagentready re-scan 2026-09-14: **Level 4 / Agent-Integrated** (was Level 1); MCP Inspector as the second client. C-6 done 2026-09-14 (chain verified, survived a reboot; the jail files moved to the operator's private host tree). Cloudflare Radar re-scan 2026-09-14: **Level 4 / Agent-Integrated**. **C-4 done 2026-09-14 20:57 UTC**: `info.fapd/fapd` 1.0.0 active in the official MCP Registry. Phase 5 complete; the blog draft (DoD 7) is written, allowlisting is the operator's call | see git log: "ops: the rehearsal's MCP rows…", "ops: record C-1…" | `research/agent-logs/agent-discovery-orchestrator-20260913.md` | 2026-09-14 (three entries) |
| 6 | **closed 2026-09-14: not available at this DNS host** (Hostinger: DNSSEC unsupported on its nameservers; zone editor has no SVCB/HTTPS records; a DNS move is ruled out by D5) | — | orchestrator log | 2026-09-14 |
| 7 | scoped only | — | — | — |
