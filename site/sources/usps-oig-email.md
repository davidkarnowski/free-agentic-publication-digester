...
**delivering** — 19 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 19 in 14 days (1.36 per day) · most recent 2026-09-25 |
| Content length | 1,090 characters average, 934 median (shortest 534, longest 3,052) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

19 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
