...
**delivering** — 18 item(s) in the last 14 days; most recent 2026-09-24, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 18 in 14 days (1.29 per day) · most recent 2026-09-24 |
| Content length | 1,099 characters average, 922 median (shortest 534, longest 3,052) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

18 item(s) in the last 14 days; most recent 2026-09-24, delivered by email.
