...
**delivering** — 17 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
...
| Content length | 1,086 characters average, 903 median (shortest 549, longest 2,541) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

17 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
