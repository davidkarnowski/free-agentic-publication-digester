...
**delivering** — 7 item(s) in the last 14 days; most recent 2026-09-11, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 7 in 14 days (0.5 per day) · most recent 2026-09-11 |
| Content length | 720 characters average, 408 median (shortest 137, longest 2,789) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

7 item(s) in the last 14 days; most recent 2026-09-11, delivered by email.
