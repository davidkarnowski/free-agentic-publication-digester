...
**delivering** — 4 item(s) in the last 14 days; most recent 2026-09-09, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 4 in 14 days (0.29 per day) · most recent 2026-09-09 |
| Content length | 1,767 characters average, 1,115 median (shortest 156, longest 4,682) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

4 item(s) in the last 14 days; most recent 2026-09-09, delivered by email.
