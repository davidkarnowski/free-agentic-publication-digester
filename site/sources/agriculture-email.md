...
**delivering** — 15 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 15 in 14 days (1.07 per day) · most recent 2026-09-17 |
| Content length | 573 characters average, 638 median (shortest 124, longest 1,179) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

15 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
