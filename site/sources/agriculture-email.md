...
**delivering** — 11 item(s) in the last 14 days; most recent 2026-09-14, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 11 in 14 days (0.79 per day) · most recent 2026-09-14 |
| Content length | 647 characters average, 668 median (shortest 124, longest 1,179) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

11 item(s) in the last 14 days; most recent 2026-09-14, delivered by email.
