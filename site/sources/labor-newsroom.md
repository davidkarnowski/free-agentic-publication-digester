...
**delivering** — 5 item(s) in the last 14 days; most recent 2026-09-17; 5 of 351 request(s) to www.dol.gov returned no content.
...
| Content length | 2,330 characters average, 1,927 median (shortest 337, longest 6,894) |
| Delivery mode | feed-fallback — the feed's summary, used because the article page could not be read |
| Our requests to www.dol.gov | 351 request(s) · 346 answered · 5 declined (4xx) · 0 server declined (5xx) · 0 no response — 1.4% returned no content |

last answered request 2026-09-21T04:01:54.401+00:00 UTC.

5 item(s) in the last 14 days; most recent 2026-09-17; 5 of 351 request(s) to www.dol.gov returned no content.

### All time

- **Our requests to www.dol.gov, all time (since 2026-07-30):** 1,568 request(s) · 1,550 answered · 18 returned no content
