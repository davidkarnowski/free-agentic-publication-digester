...
**delivering** — 84 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 84 in 14 days (6.0 per day) · most recent 2026-09-17 |
| Content length | 3,886 characters average, 4,255 median (shortest 573, longest 4,918) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

84 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
