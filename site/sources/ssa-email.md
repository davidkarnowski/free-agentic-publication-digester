...
**delivering** — 82 item(s) in the last 14 days; most recent 2026-09-14, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 82 in 14 days (5.86 per day) · most recent 2026-09-14 |
| Content length | 4,020 characters average, 4,255 median (shortest 573, longest 4,918) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

82 item(s) in the last 14 days; most recent 2026-09-14, delivered by email.
