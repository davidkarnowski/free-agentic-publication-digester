...
**delivering** — 7 item(s) in the last 14 days; most recent 2026-09-16; 0 of 361 request(s) to www.sec.gov returned no content.

This label has held since 2026-08-27T22:46:31Z (UTC) and was last re-checked 2026-09-17T03:58:34Z (UTC).
...
| Measure | Value |
|---|---|
| Items ingested | 7 in 14 days (0.5 per day) · most recent 2026-09-16 |
| Content length | 6,016 characters average, 5,879 median (shortest 4,545, longest 8,779) |
| Delivery mode | full — full article text, fetched from the item's own page |
| Our requests to www.sec.gov | 361 request(s) · 361 answered · 0 declined (4xx) · 0 server declined (5xx) · 0 no response — 0.0% returned no content |

last answered request 2026-09-17T04:25:06.982+00:00 UTC.

7 item(s) in the last 14 days; most recent 2026-09-16; 0 of 361 request(s) to www.sec.gov returned no content.

### All time

- **Our requests to www.sec.gov, all time (since 2026-07-30):** 1,462 request(s) · 1,459 answered · 3 returned no content
