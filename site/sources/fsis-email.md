...
**delivering** — 25 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 25 in 14 days (1.79 per day) · most recent 2026-09-25 |
| Content length | 960 characters average, 153 median (shortest 75, longest 14,102) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

25 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
