...
**delivering** — 13 item(s) in the last 14 days; most recent 2026-09-22, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 13 in 14 days (0.93 per day) · most recent 2026-09-22 |
| Content length | 626 characters average, 202 median (shortest 146, longest 2,839) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

13 item(s) in the last 14 days; most recent 2026-09-22, delivered by email.
