...
active · ingestion health: degraded · Executive · Tier 2 · RSS feed · Department of Commerce
...
**degraded** — 58 of 388 request(s) to www.noaa.gov returned no content (14.9%, at or above the 10% mark).

This label has held since 2026-09-04T06:42:46Z (UTC) and was last re-checked 2026-09-15T03:50:21Z (UTC).
...
| Measure | Value |
|---|---|
| Items ingested | 4 in 14 days (0.29 per day) · most recent 2026-09-10 |
| Content length | 2,890 characters average, 3,023 median (shortest 281, longest 5,233) |
| Delivery mode | feed-only — the feed's own summary — the source publishes no more than this through this channel |
| Our requests to www.noaa.gov | 388 request(s) · 330 answered · 13 declined (4xx) · 36 server declined (5xx) · 9 no response — 14.9% returned no content |

last answered request 2026-09-15T04:00:52.645+00:00 UTC.

58 of 388 request(s) to www.noaa.gov returned no content (14.9%, at or above the 10% mark).

### All time

- **Our requests to www.noaa.gov, all time (since 2026-07-30):** 1,472 request(s) · 1,287 answered · 185 returned no content
...
NOAA's news RSS feed is ingested in feed-only format; direct access to the news index and article pages returns HTTP 403, consistent with prior probes. The feed's descriptions average 1,974 characters and carry the substance of items. We ingested 6 items over 14 days at 0.43 per day, down from 1.29 per day in the prior assessment, with the most recent arriving 2026-09-03. Request reliability degraded significantly: 321 of 379 requests answered (15.3% no-response). A substantial error spike occurred 2026-09-04 with 41 failed requests concentrated in hours 0–7, then recovery. The source remains delivering but at lower volume and with higher request failure rates than the previous measurement period.
