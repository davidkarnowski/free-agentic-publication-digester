...
**delivering** — 6 item(s) in the last 14 days; most recent 2026-09-16; 0 of 360 request(s) to www.ftc.gov returned no content.
...
| Measure | Value |
|---|---|
| Items ingested | 6 in 14 days (0.43 per day) · most recent 2026-09-16 |
| Content length | 11,050 characters average, 11,080 median (shortest 9,095, longest 13,399) |
| Delivery mode | full — full article text, fetched from the item's own page |
| Our requests to www.ftc.gov | 360 request(s) · 360 answered · 0 declined (4xx) · 0 server declined (5xx) · 0 no response — 0.0% returned no content |

last answered request 2026-09-17T04:25:07.025+00:00 UTC.

6 item(s) in the last 14 days; most recent 2026-09-16; 0 of 360 request(s) to www.ftc.gov returned no content.

### All time

- **Our requests to www.ftc.gov, all time (since 2026-07-30):** 1,465 request(s) · 1,460 answered · 5 returned no content
