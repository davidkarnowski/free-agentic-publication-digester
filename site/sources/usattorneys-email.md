...
**delivering** — 306 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
...
Last 24 hours: 32 item(s) ingested

### Last 14 days

| Measure | Value |
|---|---|
| Items ingested | 306 in 14 days (21.86 per day) · most recent 2026-09-17 |
| Content length | 349 characters average, 308 median (shortest 46, longest 1,128) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

306 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
