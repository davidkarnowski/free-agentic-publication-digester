...
**delivering** — 358 item(s) in the last 14 days; most recent 2026-09-20, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 358 in 14 days (25.57 per day) · most recent 2026-09-20 |
| Content length | 345 characters average, 304 median (shortest 37, longest 1,128) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

358 item(s) in the last 14 days; most recent 2026-09-20, delivered by email.
