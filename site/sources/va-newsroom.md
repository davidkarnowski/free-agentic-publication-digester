...
**delivering** — 37 item(s) in the last 14 days; most recent 2026-09-17; 1 of 392 request(s) to news.va.gov returned no content.
...
| Measure | Value |
|---|---|
| Items ingested | 37 in 14 days (2.64 per day) · most recent 2026-09-17 |
| Content length | 7,597 characters average, 7,449 median (shortest 5,684, longest 11,209) |
| Delivery mode | full — full article text, fetched from the item's own page |
| Our requests to news.va.gov | 392 request(s) · 391 answered · 0 declined (4xx) · 0 server declined (5xx) · 1 no response — 0.3% returned no content |

last answered request 2026-09-18T04:20:15.161+00:00 UTC.

37 item(s) in the last 14 days; most recent 2026-09-17; 1 of 392 request(s) to news.va.gov returned no content.

### All time

- **Our requests to news.va.gov, all time (since 2026-07-30):** 1,597 request(s) · 1,595 answered · 2 returned no content
