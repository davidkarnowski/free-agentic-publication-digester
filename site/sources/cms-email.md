...
**delivering** — 2 item(s) in the last 14 days; most recent 2026-09-10, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 2 in 14 days (0.14 per day) · most recent 2026-09-10 |
| Content length | 1,450 characters average, 1,450 median (shortest 1,407, longest 1,492) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

2 item(s) in the last 14 days; most recent 2026-09-10, delivered by email.
