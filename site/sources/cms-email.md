...
**delivering** — 2 item(s) in the last 14 days; most recent 2026-09-24, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 2 in 14 days (0.14 per day) · most recent 2026-09-24 |
| Content length | 1,404 characters average, 1,404 median (shortest 1,264, longest 1,544) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

2 item(s) in the last 14 days; most recent 2026-09-24, delivered by email.
