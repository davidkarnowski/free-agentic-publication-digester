...
**delivering** — 111 item(s) in the last 14 days; most recent 2026-09-22, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 111 in 14 days (7.93 per day) · most recent 2026-09-22 |
| Content length | 721 characters average, 207 median (shortest 81, longest 19,796) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

111 item(s) in the last 14 days; most recent 2026-09-22, delivered by email.
