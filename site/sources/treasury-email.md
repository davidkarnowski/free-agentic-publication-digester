...
**delivering** — 108 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
...
Last 24 hours: 23 item(s) ingested

### Last 14 days

| Measure | Value |
|---|---|
| Items ingested | 108 in 14 days (7.71 per day) · most recent 2026-09-17 |
| Content length | 1,095 characters average, 207 median (shortest 81, longest 19,796) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

108 item(s) in the last 14 days; most recent 2026-09-17, delivered by email.
