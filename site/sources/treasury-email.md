...
**delivering** — 112 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 112 in 14 days (8.0 per day) · most recent 2026-09-25 |
| Content length | 588 characters average, 207 median (shortest 81, longest 12,152) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

112 item(s) in the last 14 days; most recent 2026-09-25, delivered by email.
