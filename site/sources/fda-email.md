...
**delivering** — 29 item(s) in the last 14 days; most recent 2026-09-23, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 29 in 14 days (2.07 per day) · most recent 2026-09-23 |
| Content length | 1,834 characters average, 1,460 median (shortest 272, longest 6,571) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

29 item(s) in the last 14 days; most recent 2026-09-23, delivered by email.
