...
**delivering** — 24 item(s) in the last 14 days; most recent 2026-09-15, delivered by email.
...
| Measure | Value |
|---|---|
| Items ingested | 24 in 14 days (1.71 per day) · most recent 2026-09-15 |
| Content length | 2,099 characters average, 1,666 median (shortest 287, longest 5,689) |
| Delivery mode | email-full — the bulletin carried the full item text |

Bulletins from this source are delivered to the project mailbox, so there are no requests to report. Its health is read from delivery recency alone.

24 item(s) in the last 14 days; most recent 2026-09-15, delivered by email.
