...
36 of 45 active sources delivered items in the 14 days ending 2026-09-25 — 18,186 item(s) in all, about 1299.0 per day across the directory. 13 source(s) recorded requests that returned no content, across 9 host(s), out of 35,427 request(s) we made.
...
- **Congressional Record (CREC)** (`govinfo-crec`) — active; govinfo collections API delta sync; [page](sources/govinfo-crec.md) — ingestion health: degraded; last 24 hours: 3,351 request(s) (2,461 answered, 890 returned no content) · 98 item(s) ingested. 5764 of 26574 request(s) to api.govinfo.gov returned no content (21.7%, at or above the 10% mark).
- **Congressional Bills (BILLS)** (`govinfo-bills`) — active; govinfo collections API delta sync; [page](sources/govinfo-bills.md) — ingestion health: degraded; last 24 hours: 3,351 request(s) (2,461 answered, 890 returned no content) · 44 item(s) ingested. 5764 of 26574 request(s) to api.govinfo.gov returned no content (21.7%, at or above the 10% mark).
- **Federal Register (FR)** (`govinfo-fr`) — active; govinfo collections API delta sync; [page](sources/govinfo-fr.md) — ingestion health: degraded; last 24 hours: 3,351 request(s) (2,461 answered, 890 returned no content) · 106 item(s) ingested. 5764 of 26574 request(s) to api.govinfo.gov returned no content (21.7%, at or above the 10% mark).
- **U.S. Courts Opinions (USCOURTS)** (`govinfo-uscourts`) — active; govinfo collections API delta sync; [page](sources/govinfo-uscourts.md) — ingestion health: degraded; last 24 hours: 3,351 request(s) (2,461 answered, 890 returned no content) · 797 item(s) ingested. 5764 of 26574 request(s) to api.govinfo.gov returned no content (21.7%, at or above the 10% mark).
- **Public and Private Laws (PLAW)** (`govinfo-plaw`) — active; Syncs via the govinfo collections API delta mechanism (activated 2026-07-28, delta-only).; [page](sources/govinfo-plaw.md) — ingestion health: degraded; last 24 hours: 3,351 request(s) (2,461 answered, 890 returned no content) · 2 item(s) ingested. 5764 of 26574 request(s) to api.govinfo.gov returned no content (21.7%, at or above the 10% mark).
