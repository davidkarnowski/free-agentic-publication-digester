...
36 of 45 active sources delivered items in the 14 days ending 2026-09-16 — 14,535 item(s) in all, about 1038.2 per day across the directory. 22 source(s) recorded requests that returned no content, across 17 host(s), out of 31,252 request(s) we made.
...
- **Congressional Record (CREC)** (`govinfo-crec`) — active; govinfo collections API delta sync; [page](sources/govinfo-crec.md) — ingestion health: degraded; last 24 hours: 1,715 request(s) (1,503 answered, 212 returned no content) · 236 item(s) ingested. 4254 of 22265 request(s) to api.govinfo.gov returned no content (19.1%, at or above the 10% mark).
- **Congressional Bills (BILLS)** (`govinfo-bills`) — active; govinfo collections API delta sync; [page](sources/govinfo-bills.md) — ingestion health: degraded; last 24 hours: 1,715 request(s) (1,503 answered, 212 returned no content) · 23 item(s) ingested. 4254 of 22265 request(s) to api.govinfo.gov returned no content (19.1%, at or above the 10% mark).
- **Federal Register (FR)** (`govinfo-fr`) — active; govinfo collections API delta sync; [page](sources/govinfo-fr.md) — ingestion health: degraded; last 24 hours: 1,715 request(s) (1,503 answered, 212 returned no content) · 121 item(s) ingested. 4254 of 22265 request(s) to api.govinfo.gov returned no content (19.1%, at or above the 10% mark).
- **U.S. Courts Opinions (USCOURTS)** (`govinfo-uscourts`) — active; govinfo collections API delta sync; [page](sources/govinfo-uscourts.md) — ingestion health: degraded; last 24 hours: 1,715 request(s) (1,503 answered, 212 returned no content) · 1,148 item(s) ingested. 4254 of 22265 request(s) to api.govinfo.gov returned no content (19.1%, at or above the 10% mark).
- **Public and Private Laws (PLAW)** (`govinfo-plaw`) — active; Syncs via the govinfo collections API delta mechanism (activated 2026-07-28, delta-only).; [page](sources/govinfo-plaw.md) — ingestion health: degraded; last 24 hours: 1,715 request(s) (1,503 answered, 212 returned no content) · no items ingested. 4254 of 22265 request(s) to api.govinfo.gov returned no content (19.1%, at or above the 10% mark).
...
- **Defense News Releases** (`defense-newsroom`) — active; Would poll the news-release RSS feed daily for new items.; [page](sources/defense-newsroom.md) — ingestion health: delivering; last 24 hours: 25 request(s) (24 answered, 1 returned no content) · 3 item(s) ingested. 22 item(s) in the last 14 days; most recent 2026-09-15; 16 of 355 request(s) to www.defense.gov returned no content.
- **Justice Press Releases** (`justice-newsroom`) — active; Polls the Drupal views news feed (component parameter filters to Office of Public Affairs) via AgencyClient, feed metadata only.; [page](sources/justice-newsroom.md) — ingestion health: delivering; last 24 hours: 25 request(s) (25 answered, 0 returned no content) · 101 item(s) ingested. 626 item(s) in the last 14 days; most recent 2026-09-15; 5 of 356 request(s) to www.justice.gov returned no content.
- **Labor News Releases** (`labor-newsroom`) — active; Would poll the news-release RSS feed daily for new items.; [page](sources/labor-newsroom.md) — ingestion health: delivering; last 24 hours: 26 request(s) (25 answered, 1 returned no content) · 1 item(s) ingested. 8 item(s) in the last 14 days; most recent 2026-09-15; 8 of 360 request(s) to www.dol.gov returned no content.
- **VA News Releases** (`va-newsroom`) — active; Would poll the VA news site RSS feed daily for new items.; [page](sources/va-newsroom.md) — ingestion health: delivering; last 24 hours: 29 request(s) (29 answered, 0 returned no content) · 4 item(s) ingested. 38 item(s) in the last 14 days; most recent 2026-09-15; 1 of 391 request(s) to news.va.gov returned no content.
- **DHS News Releases** (`dhs-newsroom`) — active; html-index adapter via AgencyClient — one listing fetch per poll, no article fetches (mode feed-only).; [page](sources/dhs-newsroom.md) — ingestion health: delivering; last 24 hours: 25 request(s) (25 answered, 0 returned no content) · 5 item(s) ingested. 29 item(s) in the last 14 days; most recent 2026-09-15; 2 of 353 request(s) to www.dhs.gov returned no content.
...
- **EEOC Newsroom** (`eeoc-newsroom`) — active; html-index adapter via AgencyClient — one listing fetch per poll, no article fetches (mode feed-only).; [page](sources/eeoc-newsroom.md) — ingestion health: delivering; last 24 hours: 26 request(s) (26 answered, 0 returned no content) · 1 item(s) ingested. 5 item(s) in the last 14 days; most recent 2026-09-15; 0 of 351 request(s) to www.eeoc.gov returned no content.
...
- **FDA Email Updates (email)** (`fda-email`) — active; Subscription bulletins to the project mailbox, ingested by the email adapter (src/fapd/email_sources.py; raw RFC-5322 capture, DKIM verify-and-archive).; [page](sources/fda-email.md) — ingestion health: delivering; last 24 hours: 1 item(s) ingested. 24 item(s) in the last 14 days; most recent 2026-09-15, delivered by email.
