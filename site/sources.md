...
36 of 45 active sources delivered items in the 14 days ending 2026-09-17 — 14,816 item(s) in all, about 1058.3 per day across the directory. 13 source(s) recorded requests that returned no content, across 9 host(s), out of 30,905 request(s) we made.
...
- **Congressional Record (CREC)** (`govinfo-crec`) — active; govinfo collections API delta sync; [page](sources/govinfo-crec.md) — ingestion health: degraded; last 24 hours: 2,211 request(s) (1,820 answered, 391 returned no content) · 277 item(s) ingested. 4034 of 21920 request(s) to api.govinfo.gov returned no content (18.4%, at or above the 10% mark).
- **Congressional Bills (BILLS)** (`govinfo-bills`) — active; govinfo collections API delta sync; [page](sources/govinfo-bills.md) — ingestion health: degraded; last 24 hours: 2,211 request(s) (1,820 answered, 391 returned no content) · 51 item(s) ingested. 4034 of 21920 request(s) to api.govinfo.gov returned no content (18.4%, at or above the 10% mark).
- **Federal Register (FR)** (`govinfo-fr`) — active; govinfo collections API delta sync; [page](sources/govinfo-fr.md) — ingestion health: degraded; last 24 hours: 2,211 request(s) (1,820 answered, 391 returned no content) · 104 item(s) ingested. 4034 of 21920 request(s) to api.govinfo.gov returned no content (18.4%, at or above the 10% mark).
- **U.S. Courts Opinions (USCOURTS)** (`govinfo-uscourts`) — active; govinfo collections API delta sync; [page](sources/govinfo-uscourts.md) — ingestion health: degraded; last 24 hours: 2,211 request(s) (1,820 answered, 391 returned no content) · 958 item(s) ingested. 4034 of 21920 request(s) to api.govinfo.gov returned no content (18.4%, at or above the 10% mark).
- **Public and Private Laws (PLAW)** (`govinfo-plaw`) — active; Syncs via the govinfo collections API delta mechanism (activated 2026-07-28, delta-only).; [page](sources/govinfo-plaw.md) — ingestion health: degraded; last 24 hours: 2,211 request(s) (1,820 answered, 391 returned no content) · no items ingested. 4034 of 21920 request(s) to api.govinfo.gov returned no content (18.4%, at or above the 10% mark).
