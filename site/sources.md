...
34 of 45 active sources delivered items in the 14 days ending 2026-09-26 — 18,762 item(s) in all, about 1340.1 per day across the directory. 12 source(s) recorded requests that returned no content, across 8 host(s), out of 35,361 request(s) we made.
...
- **Congressional Record (CREC)** (`govinfo-crec`) — active; govinfo collections API delta sync; [page](sources/govinfo-crec.md) — ingestion health: degraded; last 24 hours: 2,284 request(s) (1,756 answered, 528 returned no content) · 274 item(s) ingested. 5989 of 26544 request(s) to api.govinfo.gov returned no content (22.6%, at or above the 10% mark).
- **Congressional Bills (BILLS)** (`govinfo-bills`) — active; govinfo collections API delta sync; [page](sources/govinfo-bills.md) — ingestion health: degraded; last 24 hours: 2,284 request(s) (1,756 answered, 528 returned no content) · 13 item(s) ingested. 5989 of 26544 request(s) to api.govinfo.gov returned no content (22.6%, at or above the 10% mark).
- **Federal Register (FR)** (`govinfo-fr`) — active; govinfo collections API delta sync; [page](sources/govinfo-fr.md) — ingestion health: degraded; last 24 hours: 2,284 request(s) (1,756 answered, 528 returned no content) · 104 item(s) ingested. 5989 of 26544 request(s) to api.govinfo.gov returned no content (22.6%, at or above the 10% mark).
- **U.S. Courts Opinions (USCOURTS)** (`govinfo-uscourts`) — active; govinfo collections API delta sync; [page](sources/govinfo-uscourts.md) — ingestion health: degraded; last 24 hours: 2,284 request(s) (1,756 answered, 528 returned no content) · 1,147 item(s) ingested. 5989 of 26544 request(s) to api.govinfo.gov returned no content (22.6%, at or above the 10% mark).
- **Public and Private Laws (PLAW)** (`govinfo-plaw`) — active; Syncs via the govinfo collections API delta mechanism (activated 2026-07-28, delta-only).; [page](sources/govinfo-plaw.md) — ingestion health: degraded; last 24 hours: 2,284 request(s) (1,756 answered, 528 returned no content) · 1 item(s) ingested. 5989 of 26544 request(s) to api.govinfo.gov returned no content (22.6%, at or above the 10% mark).
