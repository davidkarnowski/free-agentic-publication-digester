...
def test_real_day_smoke():
    ...
    # No volume floor: real days range from pro-forma sessions (47 granules
    # observed 2026-07-29) to full legislative days (~250). Volume is a
    # property of Congress, not of the parser — assert structure instead.
    assert records, "a published issue must yield at least one granule"
