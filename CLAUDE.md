...
| MCP service | `docs/mcp-server.md`, `packages/static-mcp/`, `deploy/vps/mcp/`; fapd-web nginx config: operator's private host tree, mounted from `/opt/edge/fapd-web` (moved out 2026-09-21); host fail2ban jail: operator's private host tree, applied directly (2026-09-14) |
