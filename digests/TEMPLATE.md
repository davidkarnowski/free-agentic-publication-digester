...
<!-- Mechanical, clickable table of contents built from the digest's actual
     top-level sections; leads the digest. -->
...
*In plain terms: {section_quick_read — one model-generated sentence saying
what this section contains today; stored in section_summaries, linted
un-masked, omitted when unavailable}*
...
{data_end_date}. *(PLAW active as of 2026-07-28, delta-only: laws enacted from activation
forward appear here; the Coverage Statement carries a PLAW row.)*
