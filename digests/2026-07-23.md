...
| **Generated at** | 2026-07-24T18:16:40Z (UTC) |
| **Pipeline version** | 882dbe1 |
...
repository and identified by the pipeline version in the header (882dbe1).
Editorial principles — primary sources only, opinion-agnostic prose, mechanical
party-blind selection, full coverage accounting — are defined in
[GUIDE.md](../GUIDE.md) §2. Ruleset in effect: prompt version 1. To reproduce this digest: re-run the report stage
against the extracted records for 2026-07-23; no upstream re-fetch is required
(GUIDE.md §5).
